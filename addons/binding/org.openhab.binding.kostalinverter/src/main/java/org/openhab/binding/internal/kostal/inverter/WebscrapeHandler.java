...
public class WebscrapeHandler extends BaseThingHandler {
    ...
    public WebscrapeHandler(Thing thing) {
        ...
        channelConfigs.add(new ChannelConfig("str1Current", "td", 25, SmartHomeUnits.KILOWATT_HOUR));
        channelConfigs.add(new ChannelConfig("str2Voltage", "td", 33, SmartHomeUnits.VOLT));
        channelConfigs.add(new ChannelConfig("str2Current", "td", 39, SmartHomeUnits.KILOWATT_HOUR));
        channelConfigs.add(new ChannelConfig("l1Voltage", "td", 22, SmartHomeUnits.VOLT));
        channelConfigs.add(new ChannelConfig("l1Energy", "td", 28, SmartHomeUnits.KILOWATT_HOUR));
        channelConfigs.add(new ChannelConfig("l2Voltage", "td", 36, SmartHomeUnits.VOLT));
        channelConfigs.add(new ChannelConfig("l2Energy", "td", 42, SmartHomeUnits.KILOWATT_HOUR));
        channelConfigs.add(new ChannelConfig("l3Voltage", "td", 46, SmartHomeUnits.VOLT));
        channelConfigs.add(new ChannelConfig("l3Energy", "td", 49, SmartHomeUnits.KILOWATT_HOUR));
    }
